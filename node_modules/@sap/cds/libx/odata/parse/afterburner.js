...
function _processWhere(where, entity) {
  // REVISIT: remove once we validate query options against the return type (or not at all)
  if (!entity?.elements)
    cds.error({ status: 400, message: 'Filtering is not supported for operations that return primitive types' })
