...
class EnterpriseMessaging extends AMQPWebhookMessaging {
  ...
  startListening() {
    ...
    if (!doNotDeploy && (this._listenToAll.value || this.subscribedTopics.size)) {
      ...
      if (waitingPeriod === 0) return this._runInSequence(management.createWebhook.bind(management))()
      sleep(waitingPeriod || 5000).then(() => this._runInSequence(management.createWebhook.bind(management))())
    }
  }
