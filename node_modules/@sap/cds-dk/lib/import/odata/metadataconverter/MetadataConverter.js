...
class PropertyPathExpression extends Expression {
    ...
    interpret() {
        ...
        } else if (!this.getElement().elements && this._targetName === '$NavigationPropertyPath') {
            // elements are not given, when <NavigationPropertyPath/> is in EDMX, which is used to refresh the current context
            // OData tsc decided this should now be represented with a null value
            return {
                "=": '(null)'
            };;
        } else {
...
class AnnotationExpression extends Expression {
    ...
    interpret() {
        const element = this.getElement();
        if(!Object.hasOwn(element, "attributes") || !Object.hasOwn(element.attributes, "Term")) {
            throw new Error(message.INVALID_ANNOTATION);
        }
