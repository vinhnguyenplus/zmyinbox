  ...
  sap:
    _internal:
      content-deployment:
        versions:
          1.10.0: true
# Will be used instead of the `.Chart.Name`, e.g. when generating the Job name.
# nameOverride: name
...
# Use read only filesystem for the Job.
...
## Container command override. See https://kubernetes.io/docs/tasks/inject-data-application/define-command-argument-container/
# command:
#   - /bin/sh
#   - -c

## Container args override. See https://kubernetes.io/docs/tasks/inject-data-application/define-command-argument-container/
# args:
#   - echo
#   - "Hello World"
