...
module.exports = class HelmTemplate extends require('../../plugin') {
    ...
    async run() {
        console.log(term.warn(`The "cds add helm" command is deprecated and will be removed in the next major release. Please use the "cds add kyma" command instead.`))
        const project = readProject()
        let registry, domain, tag
