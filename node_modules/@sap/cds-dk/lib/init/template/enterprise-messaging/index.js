...
module.exports = class EnterpriseMessagingTemplate extends require('../../plugin') {
  ...
  async combine() {
    const project = readProject()
    const { addXsuaa, hasXsuaa, addKyma, addMta, srvPath, appName } = project
    ...
    if (addKyma || addMta) await merge(__dirname, 'files/event-mesh.json.hbs').into('event-mesh.json', { project })
  }
}
