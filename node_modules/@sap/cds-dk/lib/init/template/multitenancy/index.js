...
module.exports = class MultitenancyTemplate extends require('../../plugin') {
  ...
  async combine() {
    ...
    const {
      ...
      addXsuaa, hasXsuaa, addIas, hasIas, hasHana, addContainerize, addKyma, addHelm, addHelmUnifiedRuntime, hasApprouter,
      srvPath, appName
    } = project

    if (addMta || (addIas || addXsuaa) && hasMta) {
      ...
      if (isJava) {
        ...
        apis.push(requiredMtxSidecarApi4(srv, name))
      }
