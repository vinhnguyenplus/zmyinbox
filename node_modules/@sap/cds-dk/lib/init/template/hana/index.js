...
module.exports = class HanaTemplate extends require('../../plugin') {
    ...
    async run() {
        ...
        // cds10: Let cds build generate this by default
    ...
    async combine() {
        const project = readProject()
        const { addMta, hasMta, addMultitenancy, addContainerize, addKyma, isJava, hasKyma, hasMultitenancy, srvPath } = project
        ...
        if ((addContainerize || addKyma) && !hasMultitenancy) {
            const additions = [{
                in: 'modules',
