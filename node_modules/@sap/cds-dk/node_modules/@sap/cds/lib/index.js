...
const cds = exports = module.exports = global.cds = new class cds extends EventEmitter {
  ...
  get queued() { return super.queued = require('../libx/queue/api.js').queued }
  get unqueued() { return super.unqueued = require('../libx/queue/api.js').unqueued }
  get flush() { return super.flush = require('../libx/queue/api.js').cdsFlush }
