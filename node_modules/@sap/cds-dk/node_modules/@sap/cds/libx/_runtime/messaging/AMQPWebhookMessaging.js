...
class AMQPWebhookMessaging extends MessagingService {
  ...
  startListening(opt = {}) {
    ...
    if (!opt.doNotDeploy) {
      ...
      this._runInSequence(management.createQueueAndSubscriptions.bind(management))()
    }
    this._runInSequence(this.listenToClient.bind(this))(async (_topic, _payload, _other, { done, failed }) => {
